...
const UsersManagementPage = () => {
  ...
  return (
    <div className="flex h-[86vh] w-full gap-4 p-4 rounded-2xl items-center justify-center">
      <div className={`flex-1 flex flex-col rounded-2xl p-4 h-full transition-colors duration-300 ${
      ...
      <div className={`flex-3 rounded-2xl p-6 flex flex-col transition-colors duration-300 ${
        theme === 'dark' ? 'bg-[#1A2028]' : 'bg-gray-100'
      }`}>
        {selectedUser ? (
          <UserDetailsPanel
